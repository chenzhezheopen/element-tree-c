      ...
      <div className="ProductTransverse">
        ...
        <div className="product_info">
          <div className="product_name">
            <span dangerouslySetInnerHTML={{ __html: ProductInfo.productName }} title={ProductInfo.productName ? ProductInfo.productName.toString().replace(/<b>|<\/b>/g, '') : ''}></span>
          </div>
          <div className="product_price notranslate">
            ...
            <span className="oldPrice" dangerouslySetInnerHTML={{ __html: (ProductInfo.retailPrice ? React.countFix(ProductInfo.reamt, ProductInfo.retailPrice) : '') }}></span>
          </div>
        </div>
